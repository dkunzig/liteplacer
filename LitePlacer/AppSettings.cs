...
namespace LitePlacer
{
    ...
    public class MySettings
    {
        ...
        public double TapeHeightX = 100;
        public double TapeHeightY = 100;
        public double TapeHeightZ = 100;
        public double PCBHeightX = 100;
        public double PCBHeightY = 100;
        public double PCBHeightZ = 100;
